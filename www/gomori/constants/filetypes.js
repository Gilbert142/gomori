...
const FILE_TYPE_MAP = {
	...
	text: { encrypted: "HERO", decrypted: "yaml", dir: "languages/en", conflicts: true, patch: true, delta: false },
	data: { encrypted: "KEL", decrypted: "json", dir: "data", conflicts: true, patch: true, delta: false },
	data_misc: { encrypted: "PLUTO", decrypted: "yaml", dir: "data", conflicts: true, patch: true, delta: false },
	...
	text_delta: { encrypted: "HERO", decrypted: "ymld", dir: "languages/en", conflicts: false, patch: true, delta: true }, //can there also be yamld?
	data_misc_delta: { encrypted: "PLUTO", decrypted: "ymld", dir: "data", conflicts: false, patch: true, delta: true }, //can there also be yamld?
