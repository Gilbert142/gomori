...
Scene_OmoriTitleScreen.prototype.createVersionText = function() {
  this._gameVersion = new Sprite(new Bitmap(Math.ceil(Graphics.boxWidth / 4), 32))
  ...
  this._gameVersion.bitmap.drawText(`GOMORI V${gomoriVersion}`, padding ,padding , this._gameVersion.bitmap.width, 16, "left");
}
...
Scene_OmoriTitleScreen.prototype.createTitleCommands = function() {
  ...
  this._titleCommands = [];
  // Text Array
  var textList = ['NEW GAME', 'CONTINUE', 'OPTIONS']
