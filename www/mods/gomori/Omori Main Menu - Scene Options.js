...
// * Start Exit Prompt
//=============================================================================
Scene_OmoMenuBase.prototype.startExitPrompt = function() {
...
Window_OmoMenuOptionsCategory.prototype.standardPadding = function() { return 5; }
...
Window_OmoMenuOptionsGeneral.prototype.processOptionCommand = function() {
  ...
  switch (index) {
    ...
    case 1: // Fullscreen
      ...
      //Input.update();
    break;
    case 2: ConfigManager.gamepadTips = data.index === 0 ? false : true ;break;
...
Window_OmoMenuOptionsExitPromptWindow.prototype.makeCommandList = function() {
  // Get Commands Text
  var text = LanguageManager.getPluginText('optionsMenu', 'system').exitPrompt.commands;
...
// * Refresh
//=============================================================================
Window_OmoMenuOptionsExitPromptWindow.prototype.refresh = function() {
  // Super Call
